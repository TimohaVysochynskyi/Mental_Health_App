...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen flex-1 flex-col justify-center px-6 overflow-x-hidden">
      {error && (
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg overflow-hidden shadow-md">
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div
                className="flex justify-center items-center gap-x-4 bg-white"
                style={{
                  background:
                    'linear-gradient(to right, #D1D5DB, #E5E7EB, #F3F4F6)',
                }}
              >
                ...
                <button
                  className="rounded-md bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600"
                  type="submit"
                >
                  Sign in
                </button>
