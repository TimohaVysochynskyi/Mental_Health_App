      ...
      <section class="mt-[5rem] h-[150vh] text-xl">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          ...
          <div class="mb-6 lg:mb-16">
            <div
              class="items-center rounded-xl shadow sm:flex dark:border-gray-700 mb-6"
              style={{
                background:
            ...
            >
              ...
              <div class="p-5">
                ...
                <ul class="flex space-x-4 sm:mt-0">
                  <li>
                    <a
                      href="https://www.instagram.com/manan_hingorani/?hl=en"
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/manan-hingorani/"
                      class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
                        className="h-5 w-5"
                  ...
                  <li>
                    <a
                      href="https://github.com/MananHingorani2003"
                      class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
                        className="h-5 w-5"
            ...
            >
              <a href="#">
                <img
                  class="w-full h-full rounded-lg sm:rounded-none sm:rounded-l-lg"
                  src="https://pbs.twimg.com/profile_images/1545729794817785858/owAuYEH-_400x400.jpg"
                  alt="Shreya Ganjoo"
                />
              </a>
              <div class="p-5">
                ...
                <ul class="flex space-x-4 sm:mt-0">
                  <li>
                    <a
                      href="https://www.instagram.com/shreya.ganjoo/?hl=en"
                      class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
                        className="w-5 h-5"
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/shreya-ganjoo-30563822b/"
                      class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
                        className="h-5 w-5"
                  ...
                  <li>
                    <a
                      href="https://github.com/Shreyg-27"
                      class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
                        className="h-5 w-5"
